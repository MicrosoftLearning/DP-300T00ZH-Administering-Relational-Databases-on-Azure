...
2. 单击 **“+ 添加”** 打开 **“创建虚拟网络”** 页面。在 **“基本信息”** 选项卡上，完成以下信息：
...
3. 在“连接”侧边栏中，在“连接详细信息”部分填写连接信息，以连接到上一个练习中创建的 SQL 数据库。
	...
	**注意：** 可能会要求添加防火墙规则，以允许你的客户端 IP 访问此服务器。
...
4. ADS 将连接到数据库，并显示有关 DB 的一些基本信息，以及部分对象列表  
‎
...
3. 在“连接详细信息”侧边栏中，输入以下信息以连接到先前任务的 PostgreSQL 数据库：
	...
	- 用户名：**dp300admin@dp300-lab02-doc** （请注意，用户名必须包含上面指定的主机名；请使用后缀替代“doc”） 
