...
1. 在实验室虚拟机中，启动浏览器会话并导航到 [https://portal.azure.com](https://portal.azure.com/)。 

	![图片 1](../images/dp-3300-module-11-lab-01.png)

 

	在 Azure 门户屏幕顶部的搜索栏中键入订阅。单击订阅图标。
...
4. “所有资源”页面将列出所选订阅中的所有 Azure 资源。资源列表中应有一个现有虚拟机。 

 

5. 选择左侧导航中的“资源组”。

	![图 7](../images/dp-3300-module-11-lab-06.png)

	

	“资源组”边栏选项卡将列出所选订阅中的所有 Azure 资源组。页面上应列出现有资源组。 
...
7. 确保已为实验室选择适当的订阅。将资源组命名为 DP-300-Lab01。选择离你的位置最近的 Azure 区域，选择“查看 + 创建”按钮。然后选择“创建”按钮。 
	...
	![图片 12](../images/dp-3300-module-11-lab-08.png)

8. 找到页面顶部的搜索栏。搜索 Azure SQL。选择出现在“服务”下结果中的 Azure SQL 搜索结果。
...
2. 在“选择 SQL 部署选项”边栏选项卡上，打开 SQL 虚拟机下的下拉框。选择标记为“免费 SQL Server 许可证”的选项：Windows Server 2019 上的 SQL 2019 Developer。然后选择“创建”按钮。
	...
	![图片 9](../images/dp-3300-module-11-lab-11.png)
...
3. 在“创建虚拟机”边栏选项卡中，输入以下信息： 
	...
	- 大小: 标准 **D2s v3** （2 个 vCPU，8 GiB 内存；可能需要选择“大小”按钮才能查看此选项）
	...
	记下用户名和密码以备后用，因为你将在以后的实验室任务中使用它。

	![图片 14](../images/dp-3300-module-11-lab-12.png)


4. 导航到“磁盘”选项卡并查看配置。 

	![图片 15](../images/dp-3300-module-11-lab-13.png)

 
5. 导航到“网络”选项卡并查看配置。 

	![图片 16](../images/dp-3300-module-11-lab-14.png)
 

6. 导航到“管理”选项卡并查看配置。 

	![图片 19](../images/dp-3300-module-11-lab-15.png)

	记下你在此处创建的存储帐户名称，你将在后续实验室中用到。验证“启用 auto_shutdown”是否已关闭。


7. 导航到“高级”选项卡并查看配置。 

	![图片 20](../images/dp-3300-module-11-lab-16.png)


8. 导航到“SQL Server 设置”选项卡并查看配置。 

	![图片 21](../images/dp-3300-module-11-lab-17.png)
...
‎
	![图片 22](../images/dp-3300-module-11-lab-18.png)
...
1. 在虚拟机的“概述”页面上，选择“连接”按钮，然后选择“RDP”。 
	...
	![图片 26](../images/dp-3300-module-11-lab-21.png)
...
7. 将打开“远程桌面”窗口。在右侧，选择“否”按钮以指示你不希望网络上的其他设备发现该计算机。单击对话框右上角的 X 关闭“服务器管理器”对话框。 
...
12. 将以下语句复制并粘贴到新建查询窗口中： 
	...
	![图 61](../images/dp-3300-module-11-lab-45.png)


13. 选择“执行”按钮或按 F5 键执行查询。验证 2010 年销售额是否为 **43421.0364**。 

	![图 62](../images/dp-3300-module-11-lab-46.png)
...
导航到 **dp300sqlvmlab01** 虚拟机的主边栏选项卡，然后单击菜单中的“删除”按钮。 
